      ...
      <section>
        ...
        <section>
          ...
          <div
            data-aos="zoom-in-up"
            data-aos-delay="100"
            className="mx-4 my-4 text-[14px] md:mx-10 "
          >
            This website is operated by{" "}
            <span className="font-bold">Swevex Tech Solutions</span> .
            Throughout the site, the terms “we”, “us” and “our” refer to{" "}
            <span className="font-bold">Swevex Tech Solutions</span>.{" "}
            <span className="font-bold">Swevex Tech Solutions</span> offers this
          ...
          <div className="md:mx-10 md:my-10">
            ...
            >
              ...
              <div className="my-4">
                In no case shall{" "}
                <span className="font-bold">Swevex Tech Solutions</span>, our
            ...
            >
              ...
              <div className="my-4">
                You agree to indemnify, defend and hold harmless Swevex Tech
                Solutions and our parent, subsidiaries, affiliates, partners,
